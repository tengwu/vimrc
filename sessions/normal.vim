...
set runtimepath+=~/.vim/bundle/vim-diff-enhanced
set runtimepath+=~/.vim/bundle/gtags-cscope.vim
...
set runtimepath+=/usr/local/Cellar/macvim/8.2-162/MacVim.app/Contents/Resources/vim/vimfiles
set runtimepath+=/usr/local/Cellar/macvim/8.2-162/MacVim.app/Contents/Resources/vim/runtime
set runtimepath+=/usr/local/Cellar/macvim/8.2-162/MacVim.app/Contents/Resources/vim/vimfiles/after
set runtimepath+=~/.vim/after
set runtimepath+=~/.vim/bundle/Vundle.vim
set runtimepath+=~/.vim/bundle/Vundle.vim/after
set runtimepath+=~/.vim/bundle/vim-powerline/after
set runtimepath+=~/.vim/bundle/The-NERD-tree/after
...
set runtimepath+=~/.vim/bundle/vim-diff-enhanced/after
set runtimepath+=~/.vim/bundle/gtags-cscope.vim/after
set runtimepath+=~/.vim/bundle/ctrlp.vim/after
set runtimepath+=~/.vim/bundle/nerdtree-git-plugin/after
set runtimepath+=~/.vim/bundle/vim-signify/after
